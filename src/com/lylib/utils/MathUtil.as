package com.lylib.utils
{
	...
	public class MathUtil
	{
		...
		static public function distanceByPoint(p1:Point, p2:Point):Number
		{
		...
		{
			return R2D(getRadianByPoint(ox, oy, px, py));
		}
		 ...
		 *
		 */
		static public function getRadianByPoint(ox:Number, oy:Number, px:Number, py:Number):Number
		{
			var dx:Number=px - ox;
			var dy:Number=py - oy;
